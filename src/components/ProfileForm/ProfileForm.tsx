    ...
    return(
        ...
        <form onSubmit={submit}>
            ...
            <div className="form-group">
                ...
                <input type="text" className="input" id="bioInput" placeholder="Bio" onChange={(e: any) => {setBio(e.target.value)}}/>
            </div>
            <div className="form-group">
                <label htmlFor="genresInput">Genres:</label>
                <input type="text" className="input" id="genresInput" placeholder="Genres" onChange={(e: any) => {setGenres(e.target.value)}}/>
            </div>
